...
Refinery::Resources.configure do |config|
  ...
  # config.dragonfly_secret = "17c4c092b2205844b449fe6d471ab0e7618c4c81514e62c7"
  # config.dragonfly_url_format = "/system/resources/:job/:basename.:ext"
  # config.dragonfly_url_host = ""
  # config.datastore_root_path = "C:/Ruby21/sites/greenblog2/public/system/refinery/resources"
